...
let person2 = {
    ...
    fav_color: 'Blue',
    teams: {
        baseball: ['Chicago Whitesox', 'Chicago Cubs', 'New York Yankees', 'Milwaukee Brewers'],
        football: ['Chicago Bears', 'Jacksonville Jaguars', 'New Orleans Saints', 'Miami Dolphins', 'Seattle Seahawks', 'Greenbay Packers'],
        hockey: ['Chicago Blackhawks', 'Colorado Avalanche', 'Boston Brewins', 'NJ Devils'],
        basketball: ['LA Lakers', 'Chicago Bulls', 'Portland Trail Blazers', 'OKC Thunder', ],
        soccer: ['Real Madrid', 'Chicago Fire', 'Manchester United']
    }
}
...
console.log(person2.prog_languages[3])
console.log(person2.teams.baseball[2])
console.log(person2.teams.football[3])
console.log(person2.teams.hockey[3])
console.log(person2.teams.basketball[0])
console.log(person2.teams.soccer[1]) //Chicago Fire
console.log(Object.values(person2.teams))
console.log(Object.values(person2.teams)[1].length)
console.log(Object.values(person2.teams)[1][1])
console.log(Object.values(person2.teams)[0].length)
console.log("Check ^")

// console.log(Object.keys(person2.teams).length)

for(let i = 0; i<Object.keys(person2.teams).length; i++){ // 5 loops bc theres 5 kets in the team dict
    for(let j=0; j<Object.values(person2.teams)[i].length; j++){ // the number of teams in each team dict value. baseball : 4 | Football : 6 etc
        if(Object.values(person2.teams)[i][j].includes("Chicago")){
            console.log(Object.values(person2.teams)[i][j])
        }
    }
}
    ...
    //     result = str.includes(dog_names[i])
    //     if(result == true){
